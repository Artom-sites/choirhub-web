        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    className="relative bg-surface border border-border w-full max-w-sm rounded-3xl shadow-2xl overflow-hidden flex flex-col"
                >
                    ...
                    <div className="p-6 pb-0 flex flex-col items-center text-center">
                        ...
                        <h2 className="text-2xl font-bold text-text-primary tracking-tight">Підтримка MyChoir</h2>
                        <button
                            onClick={onClose}
                            className="absolute top-4 right-4 p-2 bg-surface-highlight hover:bg-border rounded-full transition-colors text-text-secondary hover:text-text-primary"
                        >
                            <X className="w-5 h-5" />
                        </button>
                    </div>
                    ...
                    <div className="p-6 space-y-6 text-center">
                        ...
                        <div className="bg-surface-highlight rounded-xl p-4 border border-border text-left">
                            <div className="flex justify-between items-end mb-2">
                                <span className="text-xs text-text-secondary font-bold uppercase tracking-wider">Ціль збору</span>
                                <span className="text-sm font-bold text-text-primary">50 000 ₴</span>
                            </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                <div className="w-full py-3 pl-10 pr-12 bg-surface-highlight border border-border rounded-xl text-text-primary font-mono text-sm tracking-wide">
                                    {CARD_NUMBER}
                                </div>
                                <button
                                    onClick={handleCopy}
                                    className="absolute inset-y-0 right-0 px-3 flex items-center justify-center text-text-secondary hover:text-text-primary transition-colors"
                                >
                    ...
                    <div className="p-4 border-t border-border bg-surface">
                        <button
                            onClick={onClose}
                            className="w-full py-3 text-text-secondary font-bold rounded-xl hover:bg-surface-highlight transition-colors text-sm"
                        >
                            Закрити
                        </button>
                    </div>
