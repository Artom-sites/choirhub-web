                ...
                {effectiveCanAdd && (
                    <div className="fixed bottom-24 right-6 z-40 flex flex-col items-end gap-3 pointer-events-none">
                            ...
                            {showAddOptions && (
                                ...
                                >
                                    <button
                                        ...
                                        className="bg-surface text-text-primary px-4 py-3 rounded-xl shadow-lg border border-border flex items-center gap-3 hover:bg-surface-highlight transition-colors"
                                    >
                                        <Music2 className="w-5 h-5 text-primary" />
                                        <span className="font-medium">Нова пісня</span>
                                    </button>
                                </motion.div>
                            )}
                        </AnimatePresence>
                        ...
                        <button
                            ...
                            className={`w-14 h-14 rounded-full shadow-xl flex items-center justify-center transition-all pointer-events-auto ${showAddOptions ? 'bg-surface text-text-primary rotate-45' : 'bg-primary text-background'}`}
                            title="Додати"
                        >
