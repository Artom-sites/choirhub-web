                ...
                <div className="space-y-4 pb-20">
                    {filteredAttendanceData.length > 0 && (
                        <div className="bg-surface border border-border rounded-3xl p-5">
                            ...
                            {/* Fixed Y-Axis Layer + Scrollable Layer */}
                            <div className="relative h-56 w-full mt-2">
                                {/* Fixed Y-Axis Layer */}
                                <div className="absolute inset-y-0 left-0 w-8 pointer-events-none z-10 bg-surface">
                                        ...
                                        <ResponsiveContainer width="100%" height="100%">
                                            <AreaChart data={filteredAttendanceData} margin={{ top: 10, right: 20, left: -20, bottom: 0 }}>
                                                ...
                                                <XAxis
                                                    ...
                                                    padding={{ right: 20 }}
                                                />
                                                {/* Hide YAxis visually, but keep layout consistent with fixed layer */}
