    ...
    return (
        <div className="pb-32 bg-background min-h-screen">
            ...
            <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
                ...
                {/* Date and Warmup Module - Combined Look */}
                <div className="bg-surface/30 rounded-[28px] border border-border/60 overflow-hidden divide-y divide-border/40 shadow-sm">
                    {/* Date Row */}
                    ...
                    <div className="flex items-center gap-3 p-4">
                        ...
                        <div className="flex-1 relative" ref={warmupDropdownRef}>
                            ...
                            >
                                <span className="text-[15px] font-medium text-text-secondary">Розспіванка:</span>
                                <span className={`text-[15px] font-bold ${warmupConductor ? 'text-text-primary' : 'text-text-secondary/50'}`}>
                                    {warmupConductor || "Не вказано"}
                                </span>
                                {canEdit && <ChevronDown className="w-4 h-4 opacity-50 ml-auto" />}
                            </div>
