    ...
    <main className="min-h-screen bg-background pb-24 selection:bg-white/30">
      ...
      {!showAccount && ((activeTab === 'home' && canEdit) || (activeTab === 'songs' && canAddSongs)) && (
        <button
          ...
          className="fixed bottom-20 md:bottom-24 right-6 w-14 h-14 bg-primary text-background rounded-full shadow-2xl flex items-center justify-center hover:scale-105 active:scale-95 transition-all z-[60]"
